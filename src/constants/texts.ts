export const TEXTS = {
  ...
  ctaParagraph2:
    'עבודתי מבוססת על הסתכלות רחבה ומעמיקה: ניתוח מספרים, הבנת מטרות ההשקעה, בחינת רמת הסיכון, התאמה אישית, לוחות זמנים והיבטים תכנוניים. לא חיפוש אחר עסקה, אלא בדיקה יסודית של ההחלטה שעומדת מאחוריה.',
  ctaParagraph3:
  ...
  whatIDoItem1FullText:
    'לרוכשים ומשקיעים בתחילת הדרך או בצומת החלטה. מיפוי מטרות, יכולת מימון, רמת סיכון והכיוון הנכון לפעולה.',
  whatIDoItem2Title: 'פגישות ייעוץ לאחר עסקה',
  whatIDoItem2FullText:
    '.למי שכבר מחזיק נכס ומתלבט לגבי המשך הדרך. בחינה שקולה של החזקה, מימוש או שינוי הסטרטגיה',
  whatIDoItem3Title: 'בחינת עסקאות נדל"ן',
  whatIDoItem3FullText:
    'בדיקה מקיפה של עסקה קיימת או מוצעת. ניתוח מספרים, סיכונים, היבטים תכנוניים והתאמה אישית – לפני החלטה.',
  whatIDoItem4Title: 'ליווי משקיעים',
  whatIDoItem4FullText:
    'ליווי אישי ומתמשך בתהליך קבלת החלטות השקעה. הגדרת הסטרטגיה, בחינת חלופות וליווי בצמתים משמעותיים.',
